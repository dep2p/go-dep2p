...
// environments.
//
// This is a fork of github.com/grandcat/zeroconf with data race fixes.
// Original copyright: Copyright (c) 2016 Stefan Smarzly, Copyright (c) 2014 Oleksandr Lobunets
package zeroconf
