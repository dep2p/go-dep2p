...
It is meant to be used as a side-effecting import, e.g.
	...
	import (
		_ "github.com/dep2p/go-dep2p/multiformats/multihash/register/all"
	)
...
import (
	_ "github.com/dep2p/go-dep2p/multiformats/multihash/register/blake2"
	_ "github.com/dep2p/go-dep2p/multiformats/multihash/register/blake3"
	_ "github.com/dep2p/go-dep2p/multiformats/multihash/register/murmur3"
	_ "github.com/dep2p/go-dep2p/multiformats/multihash/register/sha3"
)
