...
_ = realmB.Join(ctx)  // 返回 ErrAlreadyJoined
...
│  状态流转：                                                          │
│  ┌────────────┐     ┌────────────┐     ┌────────────┐              │
│  │ 建立连接   │────►│ 成为成员   │────►│ MemberJoined │            │
│  └────────────┘     └────────────┘     └────────────┘              │
│                            │                                        │
│                            ▼                                        │
│  ┌────────────┐     ┌────────────┐     ┌────────────┐              │
│  │ 连接断开   │────►│ 失去成员   │────►│ MemberLeft  │             │
│  └────────────┘     └────────────┘     └────────────┘              │
│                                                                     │
│  优点：                                                              │
│  • 无需显式"加入/退出"协议                                          │
...
DeP2P 采用多层断开检测机制，确保快速准确地感知成员离线：
...
详细说明请参考：[Realm 群聊教程](../tutorials/04-realm-chat.md)
...
| **INV-006: 连接即成员** | Realm 成员身份与连接状态绑定，断开即离开 |
