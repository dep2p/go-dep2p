...
| 决策者 | @qinglong |
| 日期 | 2025-12-28 |
| 关联 ADR | [ADR-0004](0004-control-data-separation.md) |
...
参考 `tunnelto` 的做法，其 README 明确写道：简单自托管版本不支持多实例协调；分布式版本需要 gossip/私网能力。这种"诚实声明边界"的做法值得借鉴。
...
- **与 INV-003 对齐**：明确 System Relay 和 Realm Relay 的部署边界
...
│   ✅ 提供 Relay Client 实现                                                  │
│   ✅ 提供 AutoRelay 发现机制                                                 │
│   ✅ 支持 System Relay / Realm Relay 分层 (INV-003)                         │
│                                                                              │
│   DeP2P **不提供**：                                                         │
│   ❌ 多实例 Relay 状态同步                                                   │
│   ❌ 分布式限流/计费                                                         │
...
- [ADR-0004: 控制面/数据面分离原则](0004-control-data-separation.md)
